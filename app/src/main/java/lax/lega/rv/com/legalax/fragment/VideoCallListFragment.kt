...
import lax.lega.rv.com.legalax.adapter.VideoCallListAdapter
...
class VideoCallListFragment: Fragment(), SwipeRefreshLayout.OnRefreshListener {
...
//            if (flag) {
            ...
            getLawyerList(Utils.BASE_URL + Utils.GET_VIDEO_CALL_HISTORY)
            flag = false
//            }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        v = inflater.inflate(R.layout.video_call_list_activity, container, false)
...
// alreadyHit=true;
    ...
    private fun click() {
       /* rl_click.setOnClickListener {
            ...
            val fragobj = UserVideoListFragment()
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(s: String): Boolean {
                ...
                hideKeyboardForSearchView()
                Utils.hideKeyboard(activity)
                getLawyerListSearch(Utils.BASE_URL + Utils.GET_VIDEO_CALL_HISTORY, s);
                return false
            }
...
//                if (isType == false) {
        ...
        searchView.setOnCloseListener(object : SearchView.OnCloseListener {
            override fun onClose(): Boolean {
                if (searchView.query.length == 0) {
                    list.clear()
                    getLawyerListSearch(Utils.BASE_URL + Utils.GET_VIDEO_CALL_HISTORY, "");
                }
                return false
            }
        })
    ...
    fun setProductRecyclerView() {
        val categoryNameAdapter = VideoCallListAdapter(activity!!.applicationContext, activity!!, list)
