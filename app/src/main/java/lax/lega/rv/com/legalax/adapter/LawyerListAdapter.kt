...
import lax.lega.rv.com.legalax.activities.MainActivity.activity
import lax.lega.rv.com.legalax.adapter.LawyerListAdapter.MyView
...
import lax.lega.rv.com.legalax.R.drawable.view
import lax.lega.rv.com.legalax.common.Utils
import lax.lega.rv.com.legalax.retrofit.Constant


class LawyerListAdapter(private val context: Context, private val list: ArrayList<GetLawyerPojo.Lawyer.Datum>,var option:Int) : RecyclerView.Adapter<MyView>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyView
    {
        ...
        itemView = LayoutInflater.from(parent.context).inflate(R.layout.lawyer_list_item, parent, false)
...
//        }
        ...
        Picasso.with(activity).load(Utils.IMAGESURL + list.get(position).profile_image).fit().placeholder(R.drawable.icn_user_large).into(holder.img_profile)
    }
    ...
    inner class MyView(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            mainlayout = view.findViewById<View>(R.id.mainview) as LinearLayout
