...
public class CalendarView extends RelativeLayout
    ...
    private void handleAttributes(TypedArray typedArray) {
        ...
        setBackgroundResource(R.drawable.icn_cal_bg);
        //settingsManager.setBa(calendarBackgroundColor);
...
//        flBottomSelectionBar.setLayoutTransition(new LayoutTransition());
    ...
    {
        return new MonthAdapter.MonthAdapterBuilder().setMonths(CalendarUtils.createInitialMonths(settingsManager)).setMonthDelegate(new MonthDelegate(settingsManager)).setCalendarView(this).setSelectionManager(selectionManager).createMonthAdapter();
    }
    ...
    private void setSelectionBarVisibility() {
        //flBottomSelectionBar.setVisibility(getCalendarOrientation() == OrientationHelper.HORIZONTAL ? View.GONE : View.GONE);
    ...
    public void onSnap(int position) {
        ...
        if (onMonthChangeListener != null && (previousSelectedMonth == null || !previousSelectedMonth.getMonthName().equals(month.getMonthName()))) {
